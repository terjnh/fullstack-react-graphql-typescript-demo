...
var SubjectExecutor = /** @class */ (function () {
    ...
    SubjectExecutor.prototype.broadcastBeforeEventsForAll = function () {
        ...
        if (this.softRemoveSubjects.length)
            this.softRemoveSubjects.forEach(function (subject) { return _this.queryRunner.broadcaster.broadcastBeforeSoftRemoveEvent(result, subject.metadata, subject.entity, subject.databaseEntity); });
        if (this.recoverSubjects.length)
            this.recoverSubjects.forEach(function (subject) { return _this.queryRunner.broadcaster.broadcastBeforeRecoverEvent(result, subject.metadata, subject.entity, subject.databaseEntity); });
        return result;
    };
    /**
    ...
    SubjectExecutor.prototype.broadcastAfterEventsForAll = function () {
        ...
        if (this.softRemoveSubjects.length)
            this.softRemoveSubjects.forEach(function (subject) { return _this.queryRunner.broadcaster.broadcastAfterSoftRemoveEvent(result, subject.metadata, subject.entity, subject.databaseEntity); });
        if (this.recoverSubjects.length)
            this.recoverSubjects.forEach(function (subject) { return _this.queryRunner.broadcaster.broadcastAfterRecoverEvent(result, subject.metadata, subject.entity, subject.databaseEntity); });
        return result;
    };
    /**
                            ...
                            return (0, tslib_1.__generator)(this, function (_d) {
                                switch (_d.label) {
                                    ...
                                    case 4:
                                        ...
                                        _a = (0, tslib_1.__values)(subject.metadata.relations), _b = _a.next();
                                        _d.label = 5;
                                    case 5:
            ...
            return (0, tslib_1.__generator)(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        if (this.queryRunner.connection.driver instanceof OracleDriver_1.OracleDriver) {
                    ...
                    case 2:
                        ...
                        _a = (0, tslib_1.__values)(relation.inverseEntityMetadata.relations), _b = _a.next();
                        _d.label = 3;
                    case 3:
